...
const Navbar = () => {
  ...
  const handleClick = () => {
    ...
    return (
        <div>
            <div onScroll={scrollHandler} className='flex justify-between p-5 text-[15px] tracking-widest fixed top-0 left-0 right-0 z-999 border-b-2 border-[#6b6b6b] bg-[#080808] flex-wrap style={{isScrolled ? "bg-[#080808eb] backdrop-blur-md" : "bg-[#080808eb] "}}' >
                <div className='text-[#00ff87] font-bold text-[20px] '>
                    MyPortfolio
                </div>
                <div className='flex md:gap-20 gap-x-4  mt-2'>
